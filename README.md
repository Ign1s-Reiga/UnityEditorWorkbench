...
A source-first Unity 6.3 LTS project for building a personal replacement for common productivity assets such as folder decorators and tabbed inspector tools.
...
- Unity `6000.3.14f1` or another compatible Unity 6.3 LTS patch
